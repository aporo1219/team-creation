...
public class Move_Enemy : MonoBehaviour
{
    ...
    public int Combo_Number;//コンボの種類の確認に変数
    ...
    private bool Be_Attcked;//攻撃を受けたかの判定
    private string Player_Attack＿Combo;//プレイヤーのコンボ攻撃用変数
    ...
    void Start()
    {
       ...
       //攻撃関連の変数
        ...
        Attack_Enemy_Time = 0;
        Cool_Time = 5;
        Player_Attack＿Combo = PlayerController_y.instance.AttackState;
    ...
    {
        if(other.gameObject.tag == "Player" && Be_Attcked && Player_Attack＿Combo == "GroundFirst")
        {
            Combo_Number = 1;
        }
        else if (other.gameObject.tag == "Player" && Be_Attcked && Player_Attack＿Combo == "AirFirst")
        {
            Combo_Number = 2;
        }
        else if (other.gameObject.tag == "Player" && Be_Attcked && Player_Attack＿Combo == "GroundSecound")
        {
            Combo_Number = 3;
        }
        else if (other.gameObject.tag == "Player" && Be_Attcked && Player_Attack＿Combo == "AirSecound")
        {
            Combo_Number = 4;
        }
        else if (other.gameObject.tag == "Player" && Be_Attcked && Player_Attack＿Combo == "GroundThird")
        {
            Combo_Number = 5;
        }
        else if (other.gameObject.tag == "Player" && Be_Attcked && Player_Attack＿Combo == "AirThird")
        {
            Combo_Number = 6;
        }
        else if (other.gameObject.tag == "Player" && Be_Attcked && Player_Attack＿Combo == "GroundFinish")
        {
            Combo_Number = 7;
        }
        else if (other.gameObject.tag == "Player" && Be_Attcked && Player_Attack＿Combo == "GroundFinish")
